...
public class CharacterDetailGalleryRecyclerAdapter extends RecyclerView.Adapter {
    ...
    public CharacterDetailGalleryRecyclerAdapter(Context mContext, RecyclerView recyclerView, List<MediaInfo> lsData, int animationStyle) {
