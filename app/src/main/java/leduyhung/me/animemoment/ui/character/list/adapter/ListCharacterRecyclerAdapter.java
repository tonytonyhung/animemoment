package leduyhung.me.animemoment.ui.character.list.adapter;
...
public class ListCharacterRecyclerAdapter extends RecyclerView.Adapter {
    ...
    public ListCharacterRecyclerAdapter(Context mContext, RecyclerView recyclerView, List<CharacterInfo> lsData, int animationStyle) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == Constants.Recycler.RECYCLER_ITEM_HAS_DATA)
            return new ItemVIew(LayoutInflater.from(mContext).inflate(R.layout.item_recycler_character, parent, false));
        ...
        if (holder instanceof ItemVIew) {
            ...
            ((ItemVIew) holder).item.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Logg.error(ListCharacterRecyclerAdapter.this.getClass(), "click item: " + lsData.get(position).getId() + " at index: " + position);
                    EventBus.getDefault().post(new MessageForCharacterActivity(MessageForCharacterActivity.CODE_OPEN_CHARACTER_DETAIL, lsData.get(position)));
                }
            });
        }
    }
    ...
    public void configLoadmore() {
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (ClientUtil.isSoftKeyboardShow((Activity) mContext))
